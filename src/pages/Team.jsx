      ...
      <section className="relative px-6 md:px-20 pt-32 pb-16 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <motion.h1 {...fadeUp(0.07)} className="font-display font-bold text-[clamp(2.6rem,6vw,5rem)] leading-[1.05] tracking-tight">
            Meet the <span className="font-serif italic font-normal text-lime/60">team.</span>
          </motion.h1>
        </div>
      </section>
      ...
      <section className="px-6 md:px-20 py-16">
        ...
        <div className="max-w-3xl mx-auto mt-14">
          <motion.h2
            ...
            className="font-display font-bold text-[clamp(1.6rem,3vw,2.2rem)] tracking-tight mb-6"
          >
            Core Team
          </motion.h2>
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {coreTeam.map((member, i) => (
              <motion.div
                ...
                initial={{ opacity: 0, y: 28 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: i * 0.13 + 0.15, duration: 0.65, ease }}
                className="group relative rounded-3xl overflow-hidden border border-bone/[0.07] bg-[#0e1512]"
              >
                <div className="relative flex items-center justify-center h-44 overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-b from-lime/[0.12] via-lime/[0.04] to-transparent" />
                  <div className="absolute top-[-30%] left-1/2 -translate-x-1/2 w-64 h-64 bg-lime/[0.15] rounded-full blur-[60px]" />
                  <div className="relative z-10 w-20 h-20 rounded-full bg-[#0a0f0d] border border-lime/[0.15] flex items-center justify-center shadow-[0_0_40px_rgba(200,241,53,0.08)]">
                    <span className="font-display font-bold text-[18px] text-lime">{member.initials}</span>
                  </div>
                </div>
